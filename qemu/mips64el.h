...
#define arm_get_phys_addr arm_get_phys_addr_mips64el
...
#define memory_region_perm_del memory_region_perm_del_mips64el
#define memory_region_perm_del_all memory_region_perm_del_all_mips64el
